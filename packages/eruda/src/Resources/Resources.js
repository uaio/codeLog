...
export default class Resources extends Tool {
  ...
  refreshScript() {
    ...
    let scriptDataHtml = `<li>${i18n.t('common.empty')}</li>`
  ...
  refreshStylesheet() {
    ...
    let stylesheetDataHtml = `<li>${i18n.t('common.empty')}</li>`
  ...
  refreshIframe() {
    ...
    let iframeDataHtml = `<li>${i18n.t('common.empty')}</li>`
  ...
  refreshImage() {
    ...
    let imageDataHtml = `<li>${i18n.t('common.empty')}</li>`
  ...
  _bindEvent() {
    ...
    $el
      .on('click', '.eruda-refresh-script', () => {
        container.notify(i18n.t('common.refreshed'), { icon: 'success' })
        this.refreshScript()
      })
